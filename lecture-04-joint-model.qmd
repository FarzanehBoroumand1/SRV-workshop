...
The following plot presents **predicted trajectories for four randomly selected patient IDs**, illustrating subject-specific model predictions.
...
the following plot show the dynamic predictions for one randomly selected id.
