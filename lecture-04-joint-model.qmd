...
1. a **longitudinal submodel** for repeated measurements (e.g. eGFR over time), and  
2. a **survival submodel** for the time-to-event outcome (e.g. graft failure),
