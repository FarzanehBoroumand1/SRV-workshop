...
🧠  **Interpretation of stratified Cox model**
...
## Worked Example: Time-Varying Effect of Donor Type
...
### Step 1: Fit a Cox Model With a Time-Varying Coefficient
...
### Interpretation of the Time-Varying Cox Model

| Variable                  | HR (exp(coef)) | 95% CI        | p-value        | Interpretation |
|---------------------------|---------------|---------------|----------------|----------------|
| **donor_live**            | 0.50          | 0.25 – 1.01   | 0.054 (≈ 0.05) | At the **start of follow-up** (when $\log(t) \approx 0$), recipients of a **living donor** kidney have about **50% lower hazard** of graft failure compared to deceased-donor recipients. |
| **tt(donor_live)**        | 3.53          | 2.15 – 5.79   | < 0.001 ***    | The **effect of living donor changes significantly over time**. The hazard ratio increases by roughly a factor of **3.5** for each unit increase in $\log(t)$. In other words, the early advantage from living donors **diminishes as time goes on**. |
| **donor_age**             | 1.01          | 1.00 – 1.03   | 0.14           | Older donor age shows a **small, non-significant trend** toward higher hazard of graft failure. |
| **recipient_gender (male)** | 1.58        | 1.16 – 2.13   | 0.003 **       | Male recipients have about **58% higher hazard** of graft failure than females, after adjusting for other factors. |
| **egfr_baseline**         | 0.99          | 0.97 – 1.00   | 0.032 *        | Each 1-unit higher baseline eGFR reduces the hazard of graft failure by roughly **1.5%**, indicating better baseline kidney function is **protective**. |
