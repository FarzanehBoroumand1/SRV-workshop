---
title: "Lecture 5: More detailes about the cox model"
toc: true
toc-depth: 3
---
...
nonlinear_data <- read.csv("nonlinear_cox_data.csv")
...
::: {.callout-warning}
If the effect of eGFR at baseline and age were truly linear on the log hazard scale,
we would expect the smooth curve to be approximately flat around zero.
:::
