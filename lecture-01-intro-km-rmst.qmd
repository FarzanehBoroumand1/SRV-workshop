...
The Kaplan–Meier estimator at time $t_i$ is defined as:
...
| 0          | –             | 6                        | 1.000                |
| 3          | 1             | 6                        | 1 × (1 − 1/6) = 0.833 |
| 6          | 1             | 4                        | 0.833 × (1 − 1/4) = 0.625 |
| 8          | 1             | 3                        | 0.625 × (1 − 1/3) = 0.417 |
| 12         | 1             | 2                        | 0.417 × (1 − 1/1) = 0 |
...
So far, we’ve seen that **Kaplan-Meier** does not adjust for confounders.
...
Instead, we define a fixed time point $𝝉$ and focus on Restricted Mean Survival Time (RMST):  
...
# Set truncation time τ (e.g., 36 months)
tau <- 36
