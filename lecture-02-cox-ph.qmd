...
- The average monthly hazard over that interval ≈ 4/80=0.05 per month.  
- So the risk during that month ≈ 5% (because 0.05 × 1 month).  
...
## 🚗 Speedometer and Odometer Analogy
...
**-Donor type:**  
Recipients of living donor kidneys had a 45% lower hazard of graft failure compared with those who received deceased donor kidneys (HR = 0.55, 95% CI: 0.43–0.69, p < 0.001).  

**-Donor age:**  
Each additional year of donor age was associated with a 2% increase in hazard of graft failure (HR = 1.02, 95% CI: 1.01–1.03, p < 0.001).  

How to improve the reporting HR for donor age?  
Donor age: Each 10-year increase in donor age was associated with a 22% increase in the hazard of graft failure (HR = 1.22, 95% CI: 1.13–1.34, p < 0.001).  


**-Recipient sex:**  
There was no evidence of an association between recipient sex and graft failure (HR = 1.06, 95% CI: 0.89–1.28, p = 0.52).  

**-eGFR at transplant:**  
Higher baseline eGFR was strongly protective: each 1-unit increase was associated with a 3% lower hazard of graft failure (HR = 0.97, 95% CI: 0.97–0.98, p < 0.001).  
